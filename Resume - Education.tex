...
\resumeItemListStart
    ...
    time by 20 hours a month and improving reporting accuracy by 100\%.}
...
\resumeItemListStart
  ...
  optimizing data handling and processing efficiency and saving approximately 15 hours per week of manual work.}

  \resumeItem{Constructed a reference file documenting daily CAD/USD settlements in Excel and 
  NAV reconciliation reports in Python, reducing reporting errors by 100\% and enhancing data accessibility and accuracy for further analytical purposes.}
  ...
  improved task efficiency, and team productivity.}
\resumeItemListEnd
\resumeSubHeadingListEnd
