...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    {Investment Analyst Intern}{Sep 2024 -- Present}
    {University Pension Plan Ontario (UPP)}{Toronto, ON}
  \resumeItemListStart
  
    \resumeItem{Developed and enhanced macroeconomic factor-based 
    asset allocation models to acheive target asset mix under downside 
    ...
    exposures and impact on total fund and asset risk-return profile.}

    \resumeItem{Performed scenario and sensitivity analysis to forecast the 
    impacts of geopolitical shocks and rate/FX changes to support fund-level
    investment decisions.}

  \resumeItemListEnd

  \resumeSubheading
    {Risk Modelling Intern}{Jan 2025 -- May 2025}
    {Alberta Investment Management Corporation (AIMCo)}{Toronto, ON}
  \resumeItemListStart
  
    \resumeItem{Developed and improved on total fund credit risk models across a \$170B multi-asset portfolio consisting of 26 clients
    with a focus on fixed income, private credit and private equity investments.}

    \resumeItem{Improved and monitored reports that track counterparty exposure,
    credit VaR and FX exposure for \$20B+ in derivatives and structured products.}
  
    \resumeItem{Enhanced internal credit scoring frameworks and credit risk methodology 
    and transitioned them to Blackrock's Aladdin risk management system, 
    flagging and mitigating high-risk exposures worth \$100M+.}
