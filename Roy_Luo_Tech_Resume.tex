...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Built and optimized BigQuery data warehouse schemas to handle 1M+ queries 
    monthly, improving query performance by 25\%.}

    \resumeItem{Assisted in developing financial dashboards in PowerBI powered by BigQuery, 
