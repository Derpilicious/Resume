...
\resumeSubHeadingListStart
  ...
  \resumeItemListStart
    ...
    \resumeItem{Utilizing Terraform to secure and reduce developer friction of GCP services (Dataflow, Pub/Sub, BigQuery).}

    \resumeItem{Constructing a Python ETL pipeline with SQL that processed and migrated
    financial data from on-premises Oracle and SQL data sources to a BigQuery data warehouse.}

    \resumeItem{Enhancing the developer experience by restructuring the pretraining/datatools codebase, employing Docker for
    effective dependency management, and providing comprehensive documentation for each step in the process.}
  
  \resumeItemListEnd

  \resumeSubheading
    {Data Engineering Intern}{Jan 2024 -- Apr 2024}
    {Healthcare of Ontario Pension Plan}{Toronto, ON}
  \resumeItemListStart

    \resumeItem{Developed a set of management facing Power BI dashboards that provided insights into HR headcount data,
    using SQL and Apache Airflow to automate the underlying ETL pipelines and enable daily data refreshes.}

    \resumeItem{Wrote Python scripts to extract data from Workday REST APIs, increasing the amount of
    data by 50\% and providing greater insights into employee attrition rates.}

    \resumeItem{Developed SQL stored procedures to migrate data incrementally from an on-premises database to a
    Snowflake database, reducing reliance on legacy systems.}
