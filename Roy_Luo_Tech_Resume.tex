...
\begin{itemize}[leftmargin=0.15in, label={}]
   \small{\item{
    ...
    \textbf{Tools}{: Docker, Airflow, Terraform, dbt, GCP, PowerBI, Git, Spark, Snowflake, Excel, Powerpoint} \\
...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    {Data Engineering Intern}{Sep 2024 -- Present}
  ...
  \resumeItemListStart
    ...
    \resumeItem{Developed management facing Power BI dashboards that provided insights into HR headcount data,
    using SQL and 100+ Apache Airflow dags/jobs to automate the 17 underlying ETL pipelines and enable daily data refreshes.}

    \resumeItem{Wrote Python scripts to extract data from Workday REST APIs, increasing the amount of
    data available by 250\% and providing greater insights into employee attrition rates.}

    \resumeItem{Developed SQL stored procedures to migrate data incrementally from an on-premises database to a
    Snowflake database, reducing reliance on legacy systems by 50\%.}
