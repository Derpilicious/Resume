...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Platforms and Tools}{: Microsoft PowerBI, SQL Server, Git} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
    {SimCorp Dimension Data Analyst Intern}{June 2023 -- August 2023}
...
\resumeSubHeadingListStart
    \resumeProjectHeading
        ...
        \resumeItemListStart
            ...
            \resumeItem{Implemented advanced algorithms to identify specific players in ongoing matches and extract targeted data.}
            \resumeItem{Incorporated robust error handling with the requests library and validated user inputs effectively.}
    ...
    \resumeProjectHeading
        ...
        {}
        \resumeItemListStart
            \resumeItem{Developed an R script to parse and reformat live orderbook data from Coinbase's websocket feed.}
            \resumeItem{Uploaded and stored data in SQL Server, integrated it into PowerBI using DirectQuery, and created interactive dashboard charts.}
